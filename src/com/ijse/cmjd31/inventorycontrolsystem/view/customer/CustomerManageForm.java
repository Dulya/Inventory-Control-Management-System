 ...
 * @author 1
 */
public class CustomerManageForm extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        manageLabel.setText("Manage Customer");
        ...
        managePanelLayout.setHorizontalGroup(
            ...
            .addGroup(managePanelLayout.createSequentialGroup()
                .addComponent(manageLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 238, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        viewLabel.setText("View All Customers");
    ...
    private void manageLabelMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_manageLabelMousePressed
        dPane1.removeAll();
        dPane1.repaint();
        ManageCustomerForm frame = new ManageCustomerForm();
        dPane1.add(frame);
        frame.setVisible(true);
        frame.setBounds(200, 5, 820, 562);
    ...
    private void viewLabelMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_viewLabelMousePressed
        dPane1.removeAll();
        dPane1.repaint();
        ViewAllCustomersForm frame = new ViewAllCustomersForm();
        dPane1.add(frame);
        frame.setVisible(true);
        frame.setBounds(200, 5, 760, 550);
        sameColor();
