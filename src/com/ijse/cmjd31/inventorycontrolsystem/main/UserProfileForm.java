...
public class UserProfileForm extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        priviledgeText.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                priviledgeTextActionPerformed(evt);
            }
        });
        ...
        updateNameButton.setText("Update User Name");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(36, 36, 36)
                                        .addComponent(userCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(confirmText, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 302, Short.MAX_VALUE)
                                        .addComponent(priviledgeText, javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    ...
                                    .addComponent(userCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(27, 27, 27)
    ...
    private void priviledgeTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_priviledgeTextActionPerformed
        confirmText.requestFocus();
    }//GEN-LAST:event_priviledgeTextActionPerformed
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        try {
            ...
            if (password.equals(confirmPassword)) {
                res = UserController.setUser(nameText.getText(), new String(passwordText.getPassword()), Integer.parseInt(priviledgeText.getText()));
                if (res > 0) {
                    createNewUser=true;
                    JOptionPane.showMessageDialog(null, "new User has Created!");
                    updateNameButton.setEnabled(true);
    ...
    private void updateNameButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateNameButtonActionPerformed
        ...
        priviledgeText.setText(Integer.toString(user.getPrivilege()));
        priviledgeText.setEditable(false);
        String password = user.getPassword();
        String confirmPassword = new String(confirmText.getPassword());
        if (password.equals(confirmPassword)) {
            try {
                int res = UserController.updateUserName(user.getUserName(), nameText.getText(), password);
                if (res > 0) {
                    JOptionPane.showMessageDialog(null, "User Name Updated Successfully!");
                } else {
                    JOptionPane.showMessageDialog(null, "Failed to Update User Name!");
                }
            } catch (SQLException ex) {
                Logger.getLogger(UserProfileForm.class.getName()).log(Level.SEVERE, null, ex);
            } catch (ClassNotFoundException ex) {
            ...
            JOptionPane.showMessageDialog(null, "Password does not matches! Please reConfirm the Passwordd!");
        }
    ...
    private void updatePasswordButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updatePasswordButtonActionPerformed
        ...
        if (password.equals(confirmPassword)) {
            try {
                int res = UserController.updatePassword(nameText.getText(), password);
            } catch (SQLException ex) {
                Logger.getLogger(UserProfileForm.class.getName()).log(Level.SEVERE, null, ex);
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(UserProfileForm.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void fillUserCombo() {
        ...
        try {
            ...
            userCombo.addItem("<select an User>");
            for (User user : userList) {
                userCombo.addItem(user);
            }
            b = true;
        } catch (SQLException ex) {
            Logger.getLogger(UserProfileForm.class
    ...
    private void check() {
        boolean bool = nameText.getText().isEmpty() || new String(passwordText.getPassword()).isEmpty() || priviledgeText.getText().isEmpty() || new String(confirmText.getPassword()).isEmpty();
        if (bool == false) {
